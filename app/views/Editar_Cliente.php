...
<head>
    ...
    <style>
        ...
        textarea.entrada-texto { resize: vertical; min-height: 100px; font-family: inherit; }
...
<div class="formulario-contenedor">
    ...
    <form action="index.php?accion=guardar_edicion_cliente" method="POST" style="display: flex; flex-direction: column; flex-grow: 1;">
        ...
        <div>
            ...
            <textarea name="notas" class="entrada-texto" placeholder="Fórmulas de tinte, preferencias..."><?= htmlspecialchars($cliente['notas'] ?? '') ?></textarea>
        </div>
